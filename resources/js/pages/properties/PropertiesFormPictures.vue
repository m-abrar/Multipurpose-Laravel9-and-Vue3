        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <div v-if="propertyImages.length > 0" class="card-tools">
            ...
            <div class="card-body box-profile ">
              <div class="col-md-12">
                <div class="row" v-if="propertyImages.length == 0">
                ...
                <div class="row">
                  <div style="min-width: 200px; display: flex; float:left" v-for="(attachment, index) in propertyImages">
                    <span style="float:left">#{{ attachment.order }}<br /><br /></span>

                    <span style="float:left">
                      <button class="btn btn-sm"
                        :class="propertyFeaturedImage && attachment.id === propertyFeaturedImage.id ? 'btn-success' : 'btn-default'"
            ...
            <!-- card-body -->
            <div class="card-footer" v-if="propertyImages.length > 0">
...
export default {
  ...
  setup() {
    ...
    const propertyFeaturedImage = ref([]);

    const getPropertyImages = () => {
      axios.get(`/api/property/${route.params.id}/media`)
        .then((response) => {
          propertyFeaturedImage.value = response.data.featuredMediaFile;
          propertyImages.value = response.data.mediaFiles;
    ...
    const updateOrder = () => {
      ...
      axios.put('/api/properties/images-order-update', {
    ...
    const featureAttachment = (attachment_id) => {
      ...
      var feature_image_url = `/api/property/${route.params.id}/image-update-featured/${attachment_id}`;
